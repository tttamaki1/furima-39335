...
ActiveRecord::Schema.define(version: 2023_05_02_023654) do
  ...
  create_table "purchase_histories", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "user_id", null: false
